...
import com.will.lib_network.okhttp.listener.DisposeDownloadListener;
...
public class CommonFileCallback implements Callback {
    ...
    public CommonFileCallback(DisposeDataHandler handler) {
        mListener = (DisposeDownloadListener) handler.mListener;
        mFilePath = handler.mSource;
    ...
    private File handleResponse(Response response) {
        ...
        try {
            ...
            while ((length = inputStream.read()) != -1) {
                ...
                curLen += length;
                mProgress = (int) (curLen / totalLen * 100);
